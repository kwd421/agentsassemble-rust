...
| Agent Session create/configure/lifecycle | partial; `fbebad6`, `fe568bb`, `e0a681d`, and `97816b5` correct the active identity projections, and `11d3528` removes the unsupported profile mutation UI; provider completion, cleanup, a complete Agent profile mutation owner, and packaged F-06 exit verification remain open |
