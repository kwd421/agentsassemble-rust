...
lifecycle from profile, preference, pin, search, and message-attachment operations;
room appearance remains correction work. Each corrected target route authenticates the
