...
- Comparison baseline: original `d5046473010d1353a81ee38337360e6d98f7bd6f`; public Rust baseline `fea32fa`.
- Required order: connect manager invite creation to its exact room-manager revalidation and the ready-ingress snapshot, then complete frontend activation before continuing with appearance. Update the exposure map only after a surface is reachable and verified.
