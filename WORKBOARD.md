...
- Active gate: validate, commit, and push the 192-current-ballot poll bound that closes the remaining
  lifetime cascade identified during correction review, then close critical-web and Daybreaker
  manual review of canonical lobby message edit and message/poll deletion, including every
  correction, the cumulative implementation, copied controls, and packaged lifecycle evidence.
