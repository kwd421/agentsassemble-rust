...
- Active gate: B1a/B1b, their admission-custody corrections, B2, and C1a are approved. C1b has one strict create/revoke dispatch and acceptance owner without activating copied controller state, but its shared-origin, immutable-authority capture, timestamp-domain, credential-wire, and stale-boundary-doc corrections still require a pushed candidate and final approval. C2 retained custody, UI cutover, and packaged activation follow that gate. The reviewed B1a/B1b/B2/C1a/C1b/C2 order is recorded in the active owner above.
