...
- Active gate: validate, commit, and push the bounded poll-deletion/durable vote-privacy and causal
  TCP-test corrections, then close critical-web and Daybreaker manual review of canonical lobby
  message edit and message/poll deletion, including every correction, the cumulative implementation,
  copied controls, and packaged lifecycle evidence.
