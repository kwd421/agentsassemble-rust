...
- Source structure: responsibility boundaries dominate size. 500 lines warns, 800 lines warns very strongly, and 1,000 lines is the absolute cap; split even a 250-line file when concepts or authorities differ, while a cohesive single flow may remain 600–1,000 lines.
