...
describe("room lifecycle notification", () => {
  it("checks the subscribed incarnation before invalidating the directory and closing", async () => {
    ...
    const snapshot = { ...handshakeFrames(0, 0).snap, provider_catalog: handshakeFrames(0, 0).catalog.catalog, room: { ...handshakeFrames(0, 0).snap.room, room_uid: "exact-room" } } as RoomSocketSnapshot;
