...
pub use agentsassemble_domain::{
    MAX_ATTACHMENT_BYTES, MAX_CHANNEL_MESSAGE_PINS, MAX_MESSAGE_ATTACHMENT_CONTENT_TYPE_BYTES,
    MAX_MESSAGE_ATTACHMENT_FILENAME_CHARACTERS, MAX_MESSAGE_ATTACHMENTS_PER_EVENT,
    MAX_MESSAGE_CHARACTERS, MAX_MESSAGE_EVENT_ID_BYTES, MAX_MESSAGE_SEARCH_AUTHOR_CHARACTERS,
...
pub const BROWSER_CREDENTIAL_BODY_CHARS: usize = (BROWSER_CREDENTIAL_BYTES * 4).div_ceil(3);
pub const BROWSER_CREDENTIAL_CHARS: usize =
    BROWSER_CREDENTIAL_PREFIX.len() + BROWSER_CREDENTIAL_BODY_CHARS;
...
impl RoomAction {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::ProviderRequestResolve => "provider.request.resolve",
...
pub enum ServerFrame {
    ...
    ProviderRequestSnapshot {
        request: Option<agentsassemble_domain::PendingProviderRequest>,
    },
