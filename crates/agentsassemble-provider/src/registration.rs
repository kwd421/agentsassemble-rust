...
pub(crate) struct ProviderRegistration {
    ...
    pub(crate) remote_spec: Option<&'static crate::remote_openai_spec::RemoteOpenAiSpec>,
    pub(crate) login: Option<crate::provider_login::ProviderLoginSpec>,
    pub(crate) update: Option<&'static crate::provider_update_specs::ProviderUpdateSpec>,
    pub(crate) usage: Option<crate::provider_usage::ProviderUsageReader>,
    pub(crate) turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt,
...
pub(crate) static CODEX_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    remote_spec: None,
    update: Some(&crate::provider_update_specs::CODEX),
...
pub(crate) static CLAUDE_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    remote_spec: None,
    update: Some(&crate::provider_update_specs::CLAUDE),
...
pub(crate) static OPENCODE_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    remote_spec: None,
    update: Some(&crate::provider_update_specs::OPENCODE),
...
pub(crate) static CURSOR_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    remote_spec: None,
    update: Some(&crate::provider_update_specs::CURSOR),
    usage: None,
    login: Some(crate::provider_login::ProviderLoginSpec {
        flow: crate::provider_login::ProviderLoginFlow::BrowserOauth,
        arguments: &["login"],
...
pub(crate) static GROK_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    remote_spec: None,
    update: Some(&crate::provider_update_specs::GROK),
...
pub(crate) static DEEPSEEK_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    probe_executable: "",
    remote_spec: Some(&deepseek::DEEPSEEK_SPEC),
    update: None,
    usage: Some(crate::deepseek_usage::read),
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
    configuration_authority: ProviderConfigurationAuthority::Catalog,
...
pub(crate) static CEREBRAS_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&cerebras::CEREBRAS_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) static OPENROUTER_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&openrouter::OPENROUTER_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) static VERCEL_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&vercel::VERCEL_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) static LLM_GATEWAY_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&llm_gateway::LLM_GATEWAY_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) static TOKENROUTER_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&tokenrouter::TOKENROUTER_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) static CUSTOM_API_PROVIDER: ProviderRegistration = ProviderRegistration {
    ...
    executable_required: false,
    probe_executable: "",
    remote_spec: Some(&custom_api::CUSTOM_API_SPEC),
    update: None,
    usage: None,
    login: None,
    turn_interrupt: agentsassemble_domain::ProviderTurnInterrupt::Unsupported,
...
pub(crate) fn loading_provider(registration: &ProviderRegistration) -> ProviderAvailability {
    ProviderAvailability {
        ...
        interactive: true,
        turn_interrupt: registration.turn_interrupt,
        startable: false,
        available: false,
        ...
        credential_available: registration
            .remote_spec
            .and_then(crate::remote_openai_spec::RemoteOpenAiSpec::credential_id)
            .is_some(),
