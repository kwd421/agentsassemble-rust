...
const TABLES: &[TableDefinition] = &[
    ...
    TableDefinition {
        ...
        ddl: concat!(
            ...
            "max_uses INTEGER NOT NULL CHECK(max_uses IN (1, 5, 128)), ",
    ...
    TableDefinition {
        ...
        ddl: concat!(
            ...
            "credential_fingerprint BLOB PRIMARY KEY CHECK(length(credential_fingerprint) = 32), ",
    ...
    TableDefinition {
        ...
        ddl: concat!(
            ...
            "admission_key BLOB PRIMARY KEY CHECK(length(admission_key) = 32), ",
            ...
            "session_fingerprint BLOB NOT NULL UNIQUE CHECK(length(session_fingerprint) = 32), ",
            "room_id TEXT NOT NULL, ",
            ...
            "CHECK(length(browser_credential_fingerprint) = 32), ",
            ...
            "FOREIGN KEY(invite_id) REFERENCES room_invites(invite_id) ON DELETE CASCADE, ",
            "FOREIGN KEY(room_id) REFERENCES rooms(room_id) ON DELETE CASCADE, ",
            "FOREIGN KEY(user_id) REFERENCES user_profiles(user_id) ON DELETE CASCADE, ",
