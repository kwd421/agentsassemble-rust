...
const TABLES: &[TableDefinition] = &[
    ...
    TableDefinition {
        ...
        ddl: concat!(
            ...
            "UNIQUE(invite_id, room_id, invite_scope), ",
    ...
    TableDefinition {
        ...
        ddl: concat!(
            ...
            "AND length(reusable_identity_fingerprint) = 32)), ",
            "FOREIGN KEY(invite_id, room_id, invite_scope) ",
            "REFERENCES room_invites(invite_id, room_id, invite_scope) ON DELETE CASCADE, ",
            "FOREIGN KEY(room_id) REFERENCES rooms(room_id) ON DELETE CASCADE, ",
