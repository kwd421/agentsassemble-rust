...
fn registered_routes(
    ...
    [
        ...
        crate::attendee_web::HTTP_ROUTES,
...
mod tests {
    ...
    fn dynamic_exposure_is_owned_by_the_registered_route() {
        ...
        assert_eq!(
            registered_route_exposure(HttpMethod::Delete, "/api/provider-credentials/cerebras"),
            Some(RouteExposure::Private)
        );
        assert_eq!(
            registered_route_exposure(HttpMethod::Delete, "/api/provider-credentials/openrouter"),
            Some(RouteExposure::Private)
        );
        assert_eq!(
            registered_route_exposure(HttpMethod::Delete, "/api/provider-credentials/vercel"),
            Some(RouteExposure::Private)
        );
        assert_eq!(
        ...
        assert_eq!(
            registered_route_exposure(HttpMethod::Delete, "/api/provider-credentials/custom_api"),
            Some(RouteExposure::Private)
        );
