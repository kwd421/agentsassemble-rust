...
mod attendee_tool_wire;
mod attendee_web;
mod attendee_wire;
pub use attendee_client_tools::AttendeeToolCall;
pub use attendee_tool_wire::AttendeeToolReadResponse;
mod attendee_client_run;
mod attendee_client_shutdown;
pub use attendee_client_shutdown::shutdown_attendee;
...
pub use attendee_client_run::run_attendee_session;
pub use attendee_client_runtime::{AttendeeExecution, AttendeeInterrupt, AttendeeRuntime};
