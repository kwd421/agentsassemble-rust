...
mod managed_lifecycle_tests {
    ...
    use super::{
        ...
        PublicIngress, PublicIngressAuthorization, PublicIngressControlError, PublicIngressKind,
    };
    ...
    fn origin(value: &str) -> CanonicalPublicOrigin {
        CanonicalPublicOrigin::parse(value)
            .unwrap_or_else(|error| panic!("parse test origin: {error}"))
    }
